...
router.post("/downloadExcel", verifyToken, async (req, res) => {
    try {
        ...
        worksheet.columns = [
            ...
            { header: 'Rute SJ (KM)', key: 'rute_sj', width: 25 },
            { header: 'BBM (L)', key: 'bbm', width: 15 },
            { header: 'Time Out (WIB)', key: 'time_out', width: 20 },
            { header: 'Time Back (WIB)', key: 'time_back', width: 20 },
            ...
            { header: 'Gross Load (BBL)', key: 'gross_load', width: 15 },
            { header: 'Net Load (BBL)', key: 'net_load', width: 15 },
            { header: 'Gross Unload (BBL)', key: 'gross_unload', width: 15 },
            { header: 'Net Unload (BBL)', key: 'net_unload', width: 15 },
